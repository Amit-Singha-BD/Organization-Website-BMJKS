        ...
        <div class="row g-2 d-flex justify-content-center align-items-center">
            ...
            <div class="col-12 col-lg-3">
                <div class="btn-group w-100">
                    <a href="{{ route('contact.unread') }}" class="btn btn-outline-success {{ Route::is('contact.unread') ? 'active' : '' }}"
                        id="inactiveBtn">
                        দেখা হয়নি
                    </a>
                                    ...
                                    <td data-label="অ্যাকশন">
                                        <div class="d-flex flex-row justify-content-center gap-2">
                                            ...
                                            @if (route::is('contact.unread'))
                                                <a class="btn action-btn-warning" href="https://mail.google.com/mail/?view=cm&fs=1&to={{ $contact->email }}&su={{ $contact->message_title }}&body=Type your message here" target="_blank">

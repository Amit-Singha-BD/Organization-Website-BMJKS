        ...
        <div class="col-lg-12">
            <div class="card table-card shadow-sm">
                <div class="card-header text-white text-center">
                    <i class="fa-solid fa-sitemap"></i> শাখা কমিটি সদস্য তালিকা
                </div>
                    ...
                    <table class="table align-middle mb-0">
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td data-label="ভূমিকা"><span class="badge type">সভাপতি</span></td>
                                ...
                                <td data-label="অ্যাকশন">
                                    <div class="d-flex flex-row justify-content-center gap-2">
                                        ...
                                        <button class="action-btn-success" data-bs-toggle="modal"
                            ...
                            <tr class="text-center">
                                ...
                                <td data-label="ছবি">
                                    <div class="rounded-circle bg-light d-inline-flex align-items-center justify-content-center"
                                        style="width:42px;height:42px;">AK</div>
                                </td>
                                <td data-label="নাম">জনাব আজিজুল হক</td>
                                <td data-label="ভূমিকা"><span class="badge type">সাধারণ সম্পাদক</span></td>
                ...
                <form>
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label class="form-label">ফেসবুক লিঙ্ক</label>

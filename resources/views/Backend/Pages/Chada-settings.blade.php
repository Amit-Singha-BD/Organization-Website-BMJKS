        ...
        <div class="col-md-6">
            <div class="card shadow-lg">
                <div class="card-header bg-success text-white text-center">
                    <h4 class="mb-0"> <i class="fa-solid fa-sack-dollar"></i> চাদা সেটিংস</h4>
                </div>
                <div class="card-body">
                    <form action="{{route('chada.settings.store')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @else
                            <label for="central_chada_amount" class="form-label">কেন্দ্রীয় কমিটির চাদার পরিমাণ (ইংরেজী)</label>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            @else
                            <label for="branch_chada_amount" class="form-label">শাখা কমিটির চাদার পরিমাণ (ইংরেজী)</label>
                            @enderror

				...
				<div class="form-section">
					<div class="text-center my-1">
						...
						data-bs-toggle="modal" data-bs-target="#membershipReasonModal">
							<i class="fas fa-question-circle me-2"></i> আপনি কেন আজীবন সদস্য হবেন ?
						</p>
					</div>
...
<!--আপনি কেন আজীবন সদস্য হবেন Modal -->
    ...
    <div class="modal-content border-0 shadow-lg">
      ...
      <div class="modal-body">
        <p class="lead text-dark">
          সংগঠনের আজীবন সদস্য হয়ে আপনি শুধু নিজেকে নয়, সমাজকেও এগিয়ে নিতে পারেন।
          এই সদস্যপদ আপনাকে বিভিন্ন সামাজিক, সাংস্কৃতিক ও মানবিক কার্যক্রমে সক্রিয় অংশগ্রহণের সুযোগ করে দেয়।
          এছাড়া আজীবন সদস্য হিসেবে আপনি সংগঠনের উন্নয়ন ও সিদ্ধান্তগ্রহণ প্রক্রিয়ায় ভূমিকা রাখতে পারবেন।
        </p>
      </div>

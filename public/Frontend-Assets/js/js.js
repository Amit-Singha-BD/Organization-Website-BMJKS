        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // নোটিশ ফিল্টারিং ইনিশিয়ালাইজ করুন
            initNoticeFiltering();
            
            // ক্যাপচা সিস্টেম ইনিশিয়ালাইজ করুন
            initCaptchaSystem();
        ...
        const bangladeshGovSlider = (function() {
            ...
            function initSlider() {
                ...
                cardWidth = serviceItem.offsetWidth + 20; // কার্ড প্রস্থ + গ্যাপ
        ...
        function initializeBootstrapComponents() {
            ...
            if (heroCarousel) {
                ...
                heroCarousel.addEventListener('slid.bs.carousel', function (event) {
                    console.log('क্যারousel স্লাইডে এসেছে:', event.to);
                });
            }
        }
